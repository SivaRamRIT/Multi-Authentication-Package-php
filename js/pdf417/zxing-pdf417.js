...
ZXing.LuminanceSource = function (width, height) {
	console.log('Inside LuminanceSource');
    this.width = 0;
    this.height = 0;
    this.width = width;
    this.height = height;
...
ZXing.LuminanceSource.prototype.toString = function () {
	console.log('Inside LuminanceSource.prototype.toString');
...
ZXing.BitmapLuminanceSource = function (bitmap, w, h) {
  ...
  if (typeof bitmap == 'number') {
    ...
    //console.time("luminances")
		...
		this.exposure(10);
		this.sharpen(17);
		this.channels({blue:20, green:-5, red:-2});*/
	//var that = this;
	console.log(bitmap);
	/*Caman(bitmap, function () {
		                    alert("inside Caman");
							//alert("inside");
    ...
    for(var y = 0; y < height; y++) {
      ...
      for(var x = strideOffset; x < maxIndex; x += 4) {
		...
		/*data[x] = Math.pow(data[x] / 255, 0.7) * 255;
		data[x + 1] = Math.pow(data[x + 1] / 255, 0.7) * 255;
		data[x + 2] = Math.pow(data[x + 2] / 255, 0.7) * 255;*/
